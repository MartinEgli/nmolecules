...
The code-change-control, coding guardrail and structural attribute-patching
concept is tracked in the superproject at
`docs/architecture/bricks-ai-code-change-control.md`. It defines how AI agents
can request Brick structure context before coding, consume deterministic Bricks
output after coding, propose attribute-style patches and rerun Bricks gates
while policy mutation, suppressions, baselines and rule promotion stay reviewed.
