namespace NMolecules.Bricks
{
    ...
    public enum BrickViolationKind { DependencyRule = 0, RequiredDependency = 1, RoleResolution = 2, RoleCombination = 3, PolicyConfiguration = 4, Baseline = 5, Suppression = 6, MemberCardinality = 7 }
