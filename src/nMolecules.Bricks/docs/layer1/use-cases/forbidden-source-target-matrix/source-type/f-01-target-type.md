# F-01: Forbidden Dependency From Type To Type
...
- define the forbidden source-target combination 'Type -> Type'
...
We define one forbidden dependency whose source shape is 'Type' and whose target shape is 'Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-01",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Type to Type",
...
The exact "Type -> Type" shape in this file comes from the
