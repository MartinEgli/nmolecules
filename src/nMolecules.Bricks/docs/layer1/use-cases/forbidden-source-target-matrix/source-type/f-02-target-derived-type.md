# F-02: Forbidden Dependency From Type To Derived Type
...
- define the forbidden source-target combination 'Type -> Derived Type'
...
We define one forbidden dependency whose source shape is 'Type' and whose target shape is 'Derived Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-02",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Type to Derived Type",
...
The exact "Type -> Derived Type" shape in this file comes from the
