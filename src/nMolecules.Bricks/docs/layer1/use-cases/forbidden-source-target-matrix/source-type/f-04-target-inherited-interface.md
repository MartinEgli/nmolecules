# F-04: Forbidden Dependency From Type To Inherited Interface
...
- define the forbidden source-target combination 'Type -> Inherited Interface'
...
We define one forbidden dependency whose source shape is 'Type' and whose target shape is 'Inherited Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-04",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Type to Inherited Interface",
...
The exact "Type -> Inherited Interface" shape in this file comes from the
