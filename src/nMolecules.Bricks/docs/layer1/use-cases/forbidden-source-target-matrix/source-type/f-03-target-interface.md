# F-03: Forbidden Dependency From Type To Interface
...
- define the forbidden source-target combination 'Type -> Interface'
...
We define one forbidden dependency whose source shape is 'Type' and whose target shape is 'Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-03",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Type to Interface",
...
The exact "Type -> Interface" shape in this file comes from the
