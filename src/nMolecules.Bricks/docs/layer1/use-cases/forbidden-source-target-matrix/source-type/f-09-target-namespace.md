# F-09: Forbidden Dependency From Type To Namespace
...
- define the forbidden source-target combination 'Type -> Namespace'
...
We define one forbidden dependency whose source shape is 'Type' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-09",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Type to Namespace",
...
The exact "Type -> Namespace" shape in this file comes from the
