# F-20: Forbidden Dependency From Interface To Derived Type
...
- define the forbidden source-target combination 'Interface -> Derived Type'
...
We define one forbidden dependency whose source shape is 'Interface' and whose target shape is 'Derived Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-20",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Interface to Derived Type",
...
The exact "Interface -> Derived Type" shape in this file comes from the
