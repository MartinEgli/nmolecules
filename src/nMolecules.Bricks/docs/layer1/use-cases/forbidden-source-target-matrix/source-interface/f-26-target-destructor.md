# F-26: Forbidden Dependency From Interface To Destructor
...
- define the forbidden source-target combination 'Interface -> Destructor'
...
We define one forbidden dependency whose source shape is 'Interface' and whose target shape is 'Destructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-26",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Interface to Destructor",
...
The exact "Interface -> Destructor" shape in this file comes from the
