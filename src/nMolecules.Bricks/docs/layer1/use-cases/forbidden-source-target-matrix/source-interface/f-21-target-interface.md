# F-21: Forbidden Dependency From Interface To Interface
...
- define the forbidden source-target combination 'Interface -> Interface'
...
We define one forbidden dependency whose source shape is 'Interface' and whose target shape is 'Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-21",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Interface to Interface",
...
The exact "Interface -> Interface" shape in this file comes from the
