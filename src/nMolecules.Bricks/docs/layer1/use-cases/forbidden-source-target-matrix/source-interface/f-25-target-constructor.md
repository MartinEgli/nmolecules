# F-25: Forbidden Dependency From Interface To Constructor
...
- define the forbidden source-target combination 'Interface -> Constructor'
...
We define one forbidden dependency whose source shape is 'Interface' and whose target shape is 'Constructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-25",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Interface to Constructor",
...
The exact "Interface -> Constructor" shape in this file comes from the
