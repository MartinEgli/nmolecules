# F-19: Forbidden Dependency From Interface To Type
...
- define the forbidden source-target combination 'Interface -> Type'
...
We define one forbidden dependency whose source shape is 'Interface' and whose target shape is 'Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-19",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Interface to Type",
...
The exact "Interface -> Type" shape in this file comes from the
