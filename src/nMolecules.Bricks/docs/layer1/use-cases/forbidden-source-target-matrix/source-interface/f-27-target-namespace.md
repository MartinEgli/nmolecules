# F-27: Forbidden Dependency From Interface To Namespace
...
- define the forbidden source-target combination 'Interface -> Namespace'
...
We define one forbidden dependency whose source shape is 'Interface' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-27",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Interface to Namespace",
...
The exact "Interface -> Namespace" shape in this file comes from the
