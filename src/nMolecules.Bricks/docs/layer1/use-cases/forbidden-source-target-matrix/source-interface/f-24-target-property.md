# F-24: Forbidden Dependency From Interface To Property
...
- define the forbidden source-target combination 'Interface -> Property'
...
We define one forbidden dependency whose source shape is 'Interface' and whose target shape is 'Property'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-24",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Interface to Property",
...
The exact "Interface -> Property" shape in this file comes from the
