# F-31: Forbidden Dependency From Inherited Interface To Inherited Interface
...
- define the forbidden source-target combination 'Inherited Interface -> Inherited Interface'
...
We define one forbidden dependency whose source shape is 'Inherited Interface' and whose target shape is 'Inherited Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-31",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Inherited Interface to Inherited Interface",
...
The exact "Inherited Interface -> Inherited Interface" shape in this file comes from the
