# F-34: Forbidden Dependency From Inherited Interface To Constructor
...
- define the forbidden source-target combination 'Inherited Interface -> Constructor'
...
We define one forbidden dependency whose source shape is 'Inherited Interface' and whose target shape is 'Constructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-34",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Inherited Interface to Constructor",
...
The exact "Inherited Interface -> Constructor" shape in this file comes from the
