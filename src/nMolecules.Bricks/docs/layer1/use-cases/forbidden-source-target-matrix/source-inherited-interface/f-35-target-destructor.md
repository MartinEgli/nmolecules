# F-35: Forbidden Dependency From Inherited Interface To Destructor
...
- define the forbidden source-target combination 'Inherited Interface -> Destructor'
...
We define one forbidden dependency whose source shape is 'Inherited Interface' and whose target shape is 'Destructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-35",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Inherited Interface to Destructor",
...
The exact "Inherited Interface -> Destructor" shape in this file comes from the
