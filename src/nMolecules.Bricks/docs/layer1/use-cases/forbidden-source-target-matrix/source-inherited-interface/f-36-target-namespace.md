# F-36: Forbidden Dependency From Inherited Interface To Namespace
...
- define the forbidden source-target combination 'Inherited Interface -> Namespace'
...
We define one forbidden dependency whose source shape is 'Inherited Interface' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-36",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Inherited Interface to Namespace",
...
The exact "Inherited Interface -> Namespace" shape in this file comes from the
...
{
    private ForbiddenNamespace.ForbiddenType _dependency;
}
