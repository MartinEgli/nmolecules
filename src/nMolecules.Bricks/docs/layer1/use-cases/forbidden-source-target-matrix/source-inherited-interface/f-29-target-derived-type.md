# F-29: Forbidden Dependency From Inherited Interface To Derived Type
...
- define the forbidden source-target combination 'Inherited Interface -> Derived Type'
...
We define one forbidden dependency whose source shape is 'Inherited Interface' and whose target shape is 'Derived Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-29",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Inherited Interface to Derived Type",
...
The exact "Inherited Interface -> Derived Type" shape in this file comes from the
