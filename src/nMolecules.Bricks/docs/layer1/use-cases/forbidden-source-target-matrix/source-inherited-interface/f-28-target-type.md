# F-28: Forbidden Dependency From Inherited Interface To Type
...
- define the forbidden source-target combination 'Inherited Interface -> Type'
...
We define one forbidden dependency whose source shape is 'Inherited Interface' and whose target shape is 'Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-28",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Inherited Interface to Type",
...
The exact "Inherited Interface -> Type" shape in this file comes from the
