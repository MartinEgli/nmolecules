# F-32: Forbidden Dependency From Inherited Interface To Member
...
- define the forbidden source-target combination 'Inherited Interface -> Member'
...
We define one forbidden dependency whose source shape is 'Inherited Interface' and whose target shape is 'Member'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-32",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Inherited Interface to Member",
...
The exact "Inherited Interface -> Member" shape in this file comes from the
