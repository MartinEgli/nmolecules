# F-33: Forbidden Dependency From Inherited Interface To Property
...
- define the forbidden source-target combination 'Inherited Interface -> Property'
...
We define one forbidden dependency whose source shape is 'Inherited Interface' and whose target shape is 'Property'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-33",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Inherited Interface to Property",
...
The exact "Inherited Interface -> Property" shape in this file comes from the
