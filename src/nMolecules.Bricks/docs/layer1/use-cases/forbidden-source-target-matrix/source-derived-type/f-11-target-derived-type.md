# F-11: Forbidden Dependency From Derived Type To Derived Type
...
- define the forbidden source-target combination 'Derived Type -> Derived Type'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Derived Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-11",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Derived Type",
...
The exact "Derived Type -> Derived Type" shape in this file comes from the
