# F-18: Forbidden Dependency From Derived Type To Namespace
...
- define the forbidden source-target combination 'Derived Type -> Namespace'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-18",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Namespace",
...
The exact "Derived Type -> Namespace" shape in this file comes from the
