# F-13: Forbidden Dependency From Derived Type To Inherited Interface
...
- define the forbidden source-target combination 'Derived Type -> Inherited Interface'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Inherited Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-13",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Inherited Interface",
...
The exact "Derived Type -> Inherited Interface" shape in this file comes from the
