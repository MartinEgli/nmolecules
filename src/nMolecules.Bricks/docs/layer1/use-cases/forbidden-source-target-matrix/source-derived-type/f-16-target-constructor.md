# F-16: Forbidden Dependency From Derived Type To Constructor
...
- define the forbidden source-target combination 'Derived Type -> Constructor'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Constructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-16",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Constructor",
...
The exact "Derived Type -> Constructor" shape in this file comes from the
