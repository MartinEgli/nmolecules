# F-10: Forbidden Dependency From Derived Type To Type
...
- define the forbidden source-target combination 'Derived Type -> Type'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-10",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Type",
...
The exact "Derived Type -> Type" shape in this file comes from the
