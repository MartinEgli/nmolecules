# F-15: Forbidden Dependency From Derived Type To Property
...
- define the forbidden source-target combination 'Derived Type -> Property'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Property'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-15",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Property",
...
The exact "Derived Type -> Property" shape in this file comes from the
