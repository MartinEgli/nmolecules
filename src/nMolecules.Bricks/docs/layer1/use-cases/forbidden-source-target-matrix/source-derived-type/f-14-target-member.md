# F-14: Forbidden Dependency From Derived Type To Member
...
- define the forbidden source-target combination 'Derived Type -> Member'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Member'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-14",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Member",
...
The exact "Derived Type -> Member" shape in this file comes from the
