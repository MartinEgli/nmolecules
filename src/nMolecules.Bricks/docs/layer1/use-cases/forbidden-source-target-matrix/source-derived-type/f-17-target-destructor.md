# F-17: Forbidden Dependency From Derived Type To Destructor
...
- define the forbidden source-target combination 'Derived Type -> Destructor'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Destructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-17",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Destructor",
...
The exact "Derived Type -> Destructor" shape in this file comes from the
