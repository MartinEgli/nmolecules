# F-12: Forbidden Dependency From Derived Type To Interface
...
- define the forbidden source-target combination 'Derived Type -> Interface'
...
We define one forbidden dependency whose source shape is 'Derived Type' and whose target shape is 'Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-12",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Derived Type to Interface",
...
The exact "Derived Type -> Interface" shape in this file comes from the
