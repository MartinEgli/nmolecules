# F-70: Forbidden Dependency From Destructor To Constructor
...
- define the forbidden source-target combination 'Destructor -> Constructor'
...
We define one forbidden dependency whose source shape is 'Destructor' and whose target shape is 'Constructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-70",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Destructor to Constructor",
...
The exact "Destructor -> Constructor" shape in this file comes from the
