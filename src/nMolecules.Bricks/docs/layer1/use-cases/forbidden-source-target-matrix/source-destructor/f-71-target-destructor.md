# F-71: Forbidden Dependency From Destructor To Destructor
...
- define the forbidden source-target combination 'Destructor -> Destructor'
...
We define one forbidden dependency whose source shape is 'Destructor' and whose target shape is 'Destructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-71",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Destructor to Destructor",
...
The exact "Destructor -> Destructor" shape in this file comes from the
