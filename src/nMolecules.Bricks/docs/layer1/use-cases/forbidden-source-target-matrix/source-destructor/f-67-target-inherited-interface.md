# F-67: Forbidden Dependency From Destructor To Inherited Interface
...
- define the forbidden source-target combination 'Destructor -> Inherited Interface'
...
We define one forbidden dependency whose source shape is 'Destructor' and whose target shape is 'Inherited Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-67",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Destructor to Inherited Interface",
...
The exact "Destructor -> Inherited Interface" shape in this file comes from the
