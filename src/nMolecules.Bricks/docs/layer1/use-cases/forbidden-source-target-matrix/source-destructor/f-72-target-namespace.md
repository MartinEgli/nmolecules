# F-72: Forbidden Dependency From Destructor To Namespace
...
- define the forbidden source-target combination 'Destructor -> Namespace'
...
We define one forbidden dependency whose source shape is 'Destructor' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-72",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Destructor to Namespace",
...
The exact "Destructor -> Namespace" shape in this file comes from the
