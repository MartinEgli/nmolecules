# F-69: Forbidden Dependency From Destructor To Property
...
- define the forbidden source-target combination 'Destructor -> Property'
...
We define one forbidden dependency whose source shape is 'Destructor' and whose target shape is 'Property'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-69",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Destructor to Property",
...
The exact "Destructor -> Property" shape in this file comes from the
