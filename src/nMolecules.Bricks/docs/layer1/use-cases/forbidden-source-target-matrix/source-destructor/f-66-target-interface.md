# F-66: Forbidden Dependency From Destructor To Interface
...
- define the forbidden source-target combination 'Destructor -> Interface'
...
We define one forbidden dependency whose source shape is 'Destructor' and whose target shape is 'Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-66",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Destructor to Interface",
...
The exact "Destructor -> Interface" shape in this file comes from the
