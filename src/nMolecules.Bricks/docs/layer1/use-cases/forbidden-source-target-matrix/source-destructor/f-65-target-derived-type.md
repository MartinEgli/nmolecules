# F-65: Forbidden Dependency From Destructor To Derived Type
...
- define the forbidden source-target combination 'Destructor -> Derived Type'
...
We define one forbidden dependency whose source shape is 'Destructor' and whose target shape is 'Derived Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-65",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Destructor to Derived Type",
...
The exact "Destructor -> Derived Type" shape in this file comes from the
