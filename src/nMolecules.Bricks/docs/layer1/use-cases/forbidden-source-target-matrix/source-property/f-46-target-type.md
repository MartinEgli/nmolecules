# F-46: Forbidden Dependency From Property To Type
...
- define the forbidden source-target combination 'Property -> Type'
...
We define one forbidden dependency whose source shape is 'Property' and whose target shape is 'Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-46",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Property to Type",
...
The exact "Property -> Type" shape in this file comes from the
