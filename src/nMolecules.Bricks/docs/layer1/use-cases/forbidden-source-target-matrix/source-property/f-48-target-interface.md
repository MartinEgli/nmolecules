# F-48: Forbidden Dependency From Property To Interface
...
- define the forbidden source-target combination 'Property -> Interface'
...
We define one forbidden dependency whose source shape is 'Property' and whose target shape is 'Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-48",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Property to Interface",
...
The exact "Property -> Interface" shape in this file comes from the
