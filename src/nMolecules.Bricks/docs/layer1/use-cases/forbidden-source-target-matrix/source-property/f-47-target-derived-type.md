# F-47: Forbidden Dependency From Property To Derived Type
...
- define the forbidden source-target combination 'Property -> Derived Type'
...
We define one forbidden dependency whose source shape is 'Property' and whose target shape is 'Derived Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-47",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Property to Derived Type",
...
The exact "Property -> Derived Type" shape in this file comes from the
