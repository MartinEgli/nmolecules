# F-49: Forbidden Dependency From Property To Inherited Interface
...
- define the forbidden source-target combination 'Property -> Inherited Interface'
...
We define one forbidden dependency whose source shape is 'Property' and whose target shape is 'Inherited Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-49",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Property to Inherited Interface",
...
The exact "Property -> Inherited Interface" shape in this file comes from the
