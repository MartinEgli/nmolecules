# F-50: Forbidden Dependency From Property To Member
...
- define the forbidden source-target combination 'Property -> Member'
...
We define one forbidden dependency whose source shape is 'Property' and whose target shape is 'Member'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-50",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Property to Member",
...
The exact "Property -> Member" shape in this file comes from the
