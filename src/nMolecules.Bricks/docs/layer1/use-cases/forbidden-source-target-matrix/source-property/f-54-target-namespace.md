# F-54: Forbidden Dependency From Property To Namespace
...
- define the forbidden source-target combination 'Property -> Namespace'
...
We define one forbidden dependency whose source shape is 'Property' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-54",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Property to Namespace",
...
The exact "Property -> Namespace" shape in this file comes from the
