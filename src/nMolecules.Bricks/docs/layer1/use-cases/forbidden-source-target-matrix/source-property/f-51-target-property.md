# F-51: Forbidden Dependency From Property To Property
...
- define the forbidden source-target combination 'Property -> Property'
...
We define one forbidden dependency whose source shape is 'Property' and whose target shape is 'Property'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-51",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Property to Property",
...
The exact "Property -> Property" shape in this file comes from the
