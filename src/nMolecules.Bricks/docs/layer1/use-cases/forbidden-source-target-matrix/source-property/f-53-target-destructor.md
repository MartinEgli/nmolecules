# F-53: Forbidden Dependency From Property To Destructor
...
- define the forbidden source-target combination 'Property -> Destructor'
...
We define one forbidden dependency whose source shape is 'Property' and whose target shape is 'Destructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-53",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Property to Destructor",
...
The exact "Property -> Destructor" shape in this file comes from the
