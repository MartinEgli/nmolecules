# F-39: Forbidden Dependency From Member To Interface
...
- define the forbidden source-target combination 'Member -> Interface'
...
We define one forbidden dependency whose source shape is 'Member' and whose target shape is 'Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-39",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Member to Interface",
...
The exact "Member -> Interface" shape in this file comes from the
