# F-42: Forbidden Dependency From Member To Property
...
- define the forbidden source-target combination 'Member -> Property'
...
We define one forbidden dependency whose source shape is 'Member' and whose target shape is 'Property'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-42",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Member to Property",
...
The exact "Member -> Property" shape in this file comes from the
