# F-41: Forbidden Dependency From Member To Member
...
- define the forbidden source-target combination 'Member -> Member'
...
We define one forbidden dependency whose source shape is 'Member' and whose target shape is 'Member'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-41",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Member to Member",
...
The exact "Member -> Member" shape in this file comes from the
