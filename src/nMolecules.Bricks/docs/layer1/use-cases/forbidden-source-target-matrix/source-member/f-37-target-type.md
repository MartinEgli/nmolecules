# F-37: Forbidden Dependency From Member To Type
...
- define the forbidden source-target combination 'Member -> Type'
...
We define one forbidden dependency whose source shape is 'Member' and whose target shape is 'Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-37",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Member to Type",
...
The exact "Member -> Type" shape in this file comes from the
