# F-45: Forbidden Dependency From Member To Namespace
...
- define the forbidden source-target combination 'Member -> Namespace'
...
We define one forbidden dependency whose source shape is 'Member' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-45",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Member to Namespace",
...
The exact "Member -> Namespace" shape in this file comes from the
