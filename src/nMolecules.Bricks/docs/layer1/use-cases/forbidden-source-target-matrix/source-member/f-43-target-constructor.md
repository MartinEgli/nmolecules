# F-43: Forbidden Dependency From Member To Constructor
...
- define the forbidden source-target combination 'Member -> Constructor'
...
We define one forbidden dependency whose source shape is 'Member' and whose target shape is 'Constructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-43",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Member to Constructor",
...
The exact "Member -> Constructor" shape in this file comes from the
