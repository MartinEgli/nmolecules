# F-40: Forbidden Dependency From Member To Inherited Interface
...
- define the forbidden source-target combination 'Member -> Inherited Interface'
...
We define one forbidden dependency whose source shape is 'Member' and whose target shape is 'Inherited Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-40",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Member to Inherited Interface",
...
The exact "Member -> Inherited Interface" shape in this file comes from the
