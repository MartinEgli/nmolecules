# F-57: Forbidden Dependency From Constructor To Interface
...
- define the forbidden source-target combination 'Constructor -> Interface'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-57",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Interface",
...
The exact "Constructor -> Interface" shape in this file comes from the
