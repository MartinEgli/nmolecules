# F-58: Forbidden Dependency From Constructor To Inherited Interface
...
- define the forbidden source-target combination 'Constructor -> Inherited Interface'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Inherited Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-58",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Inherited Interface",
...
The exact "Constructor -> Inherited Interface" shape in this file comes from the
