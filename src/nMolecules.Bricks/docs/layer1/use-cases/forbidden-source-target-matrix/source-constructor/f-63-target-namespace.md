# F-63: Forbidden Dependency From Constructor To Namespace
...
- define the forbidden source-target combination 'Constructor -> Namespace'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-63",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Namespace",
...
The exact "Constructor -> Namespace" shape in this file comes from the
