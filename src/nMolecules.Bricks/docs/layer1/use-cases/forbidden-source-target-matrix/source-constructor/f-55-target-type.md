# F-55: Forbidden Dependency From Constructor To Type
...
- define the forbidden source-target combination 'Constructor -> Type'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-55",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Type",
...
The exact "Constructor -> Type" shape in this file comes from the
