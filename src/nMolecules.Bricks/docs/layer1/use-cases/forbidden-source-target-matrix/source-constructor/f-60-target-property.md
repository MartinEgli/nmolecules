# F-60: Forbidden Dependency From Constructor To Property
...
- define the forbidden source-target combination 'Constructor -> Property'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Property'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-60",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Property",
...
The exact "Constructor -> Property" shape in this file comes from the
