# F-62: Forbidden Dependency From Constructor To Destructor
...
- define the forbidden source-target combination 'Constructor -> Destructor'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Destructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-62",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Destructor",
...
The exact "Constructor -> Destructor" shape in this file comes from the
