# F-59: Forbidden Dependency From Constructor To Member
...
- define the forbidden source-target combination 'Constructor -> Member'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Member'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-59",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Member",
...
The exact "Constructor -> Member" shape in this file comes from the
