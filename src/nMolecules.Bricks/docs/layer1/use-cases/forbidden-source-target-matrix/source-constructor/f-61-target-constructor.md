# F-61: Forbidden Dependency From Constructor To Constructor
...
- define the forbidden source-target combination 'Constructor -> Constructor'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Constructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-61",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Constructor",
...
The exact "Constructor -> Constructor" shape in this file comes from the
