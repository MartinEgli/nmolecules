# F-56: Forbidden Dependency From Constructor To Derived Type
...
- define the forbidden source-target combination 'Constructor -> Derived Type'
...
We define one forbidden dependency whose source shape is 'Constructor' and whose target shape is 'Derived Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-56",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Constructor to Derived Type",
...
The exact "Constructor -> Derived Type" shape in this file comes from the
