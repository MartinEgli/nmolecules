# F-74: Forbidden Dependency From Namespace To Derived Type
...
- define the forbidden source-target combination 'Namespace -> Derived Type'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Derived Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-74",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Derived Type",
...
The exact "Namespace -> Derived Type" shape in this file comes from the
