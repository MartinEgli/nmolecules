# F-81: Forbidden Dependency From Namespace To Namespace
...
- define the forbidden source-target combination 'Namespace -> Namespace'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Namespace'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-81",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Namespace",
...
The exact "Namespace -> Namespace" shape in this file comes from the
