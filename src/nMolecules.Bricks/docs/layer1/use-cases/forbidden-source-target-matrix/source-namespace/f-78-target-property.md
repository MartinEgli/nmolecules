# F-78: Forbidden Dependency From Namespace To Property
...
- define the forbidden source-target combination 'Namespace -> Property'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Property'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-78",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Property",
...
The exact "Namespace -> Property" shape in this file comes from the
