# F-76: Forbidden Dependency From Namespace To Inherited Interface
...
- define the forbidden source-target combination 'Namespace -> Inherited Interface'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Inherited Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-76",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Inherited Interface",
...
The exact "Namespace -> Inherited Interface" shape in this file comes from the
