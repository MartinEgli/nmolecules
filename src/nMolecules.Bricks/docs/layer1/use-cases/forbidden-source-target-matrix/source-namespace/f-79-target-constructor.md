# F-79: Forbidden Dependency From Namespace To Constructor
...
- define the forbidden source-target combination 'Namespace -> Constructor'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Constructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-79",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Constructor",
...
The exact "Namespace -> Constructor" shape in this file comes from the
