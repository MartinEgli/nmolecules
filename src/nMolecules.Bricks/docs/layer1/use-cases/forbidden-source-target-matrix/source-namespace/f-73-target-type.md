# F-73: Forbidden Dependency From Namespace To Type
...
- define the forbidden source-target combination 'Namespace -> Type'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Type'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-73",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Type",
...
The exact "Namespace -> Type" shape in this file comes from the
