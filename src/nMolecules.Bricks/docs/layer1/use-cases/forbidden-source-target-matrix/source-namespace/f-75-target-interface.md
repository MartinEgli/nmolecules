# F-75: Forbidden Dependency From Namespace To Interface
...
- define the forbidden source-target combination 'Namespace -> Interface'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Interface'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-75",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Interface",
...
The exact "Namespace -> Interface" shape in this file comes from the
