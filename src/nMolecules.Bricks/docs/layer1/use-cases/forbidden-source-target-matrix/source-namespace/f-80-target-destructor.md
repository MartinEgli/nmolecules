# F-80: Forbidden Dependency From Namespace To Destructor
...
- define the forbidden source-target combination 'Namespace -> Destructor'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Destructor'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-80",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Destructor",
...
The exact "Namespace -> Destructor" shape in this file comes from the
