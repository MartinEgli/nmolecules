# F-77: Forbidden Dependency From Namespace To Member
...
- define the forbidden source-target combination 'Namespace -> Member'
...
We define one forbidden dependency whose source shape is 'Namespace' and whose target shape is 'Member'.
...
new BrickPolicy
{
    Name = "Layer1.Forbidden.F-77",
    Rules =
    [
        new BrickRule
        {
            Name = "Forbidden dependency from Namespace to Member",
...
The exact "Namespace -> Member" shape in this file comes from the
